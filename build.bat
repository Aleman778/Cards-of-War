...
IF NOT EXIST SDL2_mixer.dll copy ..\lib\x64\SDL2_mixer.dll SDL2_mixer.dll
...
IF NOT EXIST libmpg123-0.dll copy ..\lib\x64\libmpg123-0.dll libmpg123-0.dll

set compiler_flags=-WL -Od -nologo -fp:fast -fp:except- -Gm- -GR- -EHa- -Zo -Oi -WX -W4
set compiler_flags=-wd4996 -wd4201 -wd4100 -wd4189 -wd4505 -wd4127 -FC -Zi -GS- -Gs9999999 %compiler_flags%
set compiler_flags=-Od -DBUILD_DEBUG=1 -I ../include %compiler_flags%

cl %compiler_flags% ../code/main.c -link ..\lib\x64\SDL2.lib ..\lib\x64\SDL2_image.lib ..\lib\x64\SDL2_ttf.lib ..\lib\x64\SDL2_mixer.lib 
